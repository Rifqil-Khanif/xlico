 ...
 * @version 4.0
 * @description V.S.L-MD, A Multi-functional WhatsApp user bot.
 * @base DGXeon
...
async function replygcxlicon2(txt) {
  const xliconnewrep = {      
      contextInfo: {
          ...
          externalAdReply: {  
              showAdAttribution: true,
              title: "Join Our WhatsApp Group", // Judul
              body: "Click here to join!", // Deskripsi
              thumbnailUrl: 'https://i.ibb.co/yhgtCXh/68747470733a2f2f69696c692e696f2f64455433756b582e6d642e706e67.png', // Thumbnail opsional
              sourceUrl: "https://chat.whatsapp.com/Kh1kOsK33GCEohpf7ezrVs", // Tautan grup WhatsApp
          },
      },
      text: txt,
  };
...
break;
  ...
  case 'updateddadaddaa-nadadadadadow': { 
    if (!XliconTheCreator) { 
    ...
    const zipUrl = 'https://github.com/salmanytofficial/V.S.L-MD/archive/refs/heads/main.zip';
...
case 'socfsfsdfdialmedia': 
case 'sosfdsfsdfsfdsmed': 
case 'updfdsfdsfsfate': {
    const slides = [
        [
...
case 'score':
  ...
  break;
    ...
    let teks = `✨ *${global.botname} Script* ✨\n\n` +
               `📺 *Contact Me* https://wa.me/628895154319\n` +
               ` @${me.split('@')[0]}! \n`;
...
if (!text) return replygcxlicon('Where is the text?')
        ...
        break
			...
			case 'ssweb': {
				if (!text) return replygcxlicon(`Example: ${prefix + command} https://github.com`)
...
// █ ▀ █ ██▄ █ ▀█ █▄█   █▄▄ █▄█ █ ▀ █ █ ▀ █ █▀█ █ ▀█ █▄▀ ▄██ 
			...
			// Menu
      case 'p': case 'bot':    case 'menu': case 'help': case 'alive': {
